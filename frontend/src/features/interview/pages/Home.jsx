...
const Home = () => {
  ...
  const selfWordCount = countWords(selfDescription);
  const isGenerateDisabled =
    loading || jobWordCount < jobWordCap || selfWordCount < selfWordCap;
  ...
  const handleGenerateReport = async () => {
    ...
    if (jobWordCount < 150) {
      alert("At least 200 words for job description.");
      return;
    }

    if (selfWordCount < 100) {
      alert("At least 200 words for self description.");
      return;
    }
    ...
    <main className="home">
      ...
      <div className="home-container">
        <header className="home-header">
          ...
          <p>
            Upload your resume and the target job description to generate your
            interview report.
          </p>
        </header>
          ...
          <div className="left">
            <div className="input-field">
              ...
              <div className="textarea-wrapper">
                ...
                ></textarea>
                <div className={`word-count ${jobWordCount >= jobWordCap ? 'tick' : ''}`}>
                  {jobWordCount >= jobWordCap ? (
          ...
          <div className="right">
            ...
            <div className="input-field">
              ...
              <div className="textarea-wrapper">
                ...
                ></textarea>
                <div className={`word-count ${selfWordCount >= selfWordCap ? 'tick' : ''}`}>
                  {selfWordCount >= selfWordCap ? (
                    <svg viewBox="0 0 24 24" aria-hidden="true">
                      <path
                        d="M20 6L9 17l-5-5"
                        fill="none"
